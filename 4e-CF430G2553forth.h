...
; ----------------------------------------------------------------------
; 4e-CF430G2553forth.h: - Register, Model, Macro declarations - MSP430G2553
; ----------------------------------------------------------------------
...
#define RAMEND      (0x0400) // ok mk
#define USERFLASHSTART  (0xC000) // ok mk 
#define USERFLASHEND    (0xD1FF) // muss übereinstimmen mit -P CODE linker 
